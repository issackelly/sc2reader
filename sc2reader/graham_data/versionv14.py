...
class version(object):
	...
	class Research():
		cancel = { "code" : 0x07000}  # Generic ESC cancel
		cancel_unit = { "code" : 0x007100}  # Cancel + build id

	class Production():
		set_rally_point = { "code" : 0x005820}
		set_rally_target = { "code" : 0x005820}
		cancel = { "code" : 0x006c00}  # Generic ESC cancel
		cancel_unit = { "code" : 0x006d60}  # Cancel + build id
	...
	class Starport():
		...
		addon_techlab_move = { "code" : 0x010900,"min" : 50, "gas" : 25, "time" : 25}
		addon_techlab_cancel = { "code" : 0x02806}

		addon_reactor = { "code" : 0x010901,"min" : 50, "gas" : 50, "time" : 50}
		addon_reactor_move = { "code" : 0x010901,"min" : 50, "gas" : 50, "time" : 50}
	...
	class TemplarArchive():
		code = 0x006001
		khay_amulet = { "code" : "R.PROTOSS_KHAYDARIN_AMULET",  "min" : 150, "gas" : 150, "time" : 110}
