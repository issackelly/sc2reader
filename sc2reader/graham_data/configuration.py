...
def Data(conf):    
    ...
    def DataObject(clazz):
        ...
        clazz.abilities[conf.DataObject.right_click["code"]]  = {"code" : 1 , "code" :53, "type" : "click" , "name" : "Right Click"}
        clazz.abilities[conf.DataObject.right_click_in_fog["code"]]  = {"code" :54, "type" : "click" , "name" : "Right Click in Fog"}
        return clazz
    ...
    def Attacker(clazz):
        clazz.abilities[conf.Attacker.attack_move["code"]]  = {"code" :66, "type" : "action" , "name" : "Attack Move"}
        clazz.abilities[conf.Attacker.attack_object["code"]]  = {"code" :67, "type" : "action" , "name" : "Attack Object"}
        return clazz
    ...
    def Supporter(clazz):
        clazz.abilities[conf.Supporter.scan_move["code"]]  = {"code" :75, "type" : "action" , "name" : "scan move"}
        clazz.abilities[conf.Supporter.scan_target["code"]]  = {"code" :76, "type" : "action" , "name" : "scan target"}
        return clazz

    def Building(clazz):
        clazz.abilities[conf.Building.cancel["code"]]  = {"code" :80, "type" : "cancel" , "name" : "cancel"}
        return clazz

    def TerranBuilding(clazz):
        clazz.abilities[conf.TerranBuilding.halt_build["code"]]  = {"code" :84, "type" : "cancel" , "name" : "halt"}
        return clazz
    ...
    class data:
        ...
        class SCV():
            abilities = {}
            code = conf.SCV.code
            addObject(abilities,conf.SCV.gather_resources,129, "action" , "Gather Resources")
            ...
            addObject(abilities,conf.SCV.halt,133,  "action" ,  " halt") 
            addObject(abilities,conf.SCV.command_center,134,  "build" ,  "command") 
            addObject(abilities,conf.SCV.supply_depot,135,  "build",  "supply") 
            addObject(abilities,conf.SCV.barracks,136,  "build" ,  "barracks") 
            addObject(abilities,conf.SCV.engineering_bay,137,  "build" ,  "engineering") 
            addObject(abilities,conf.SCV.missle_turret,138,  "build" ,  "missle") 
            addObject(abilities,conf.SCV.bunker,139,  "build" ,  " bunker") 
            addObject(abilities,conf.SCV.refinery,140,  "build" ,  "refinery") 
            addObject(abilities,conf.SCV.sensor_tower,141,  "build" ,  "sensor") 
            addObject(abilities,conf.SCV.ghost_academy,142,  "build" ,  "ghost academy") 
            ...
            addObject(abilities,conf.SCV.fusion_core,146,  "build" ,  "fusion core")
        ...
        class Ghost():
            ...
            addObject(abilities,conf.Ghost.cloak_on,181,  "action" ,  "cloak_on") 
            addObject(abilities,conf.Ghost.cloak_off,182,  "action" ,  "cloak_off") 
            addObject(abilities,conf.Ghost.nuke_start,183,  "action" ,  "nuke") 
            addObject(abilities,conf.Ghost.nuke_cancel,184,  "action" ,  "nuke_cancel") 
            ...
            addObject(abilities,conf.Ghost.emp_round,187,  "action" ,  "emp") 
            addObject(abilities,conf.Ghost.sniper_round,188,  "action" ,  "sniper") 
        ...
        class SiegeTank():
            ...
            addObject(abilities,conf.SiegeTank.seige_mode_on,196,  "changestate" ,  "seige_mode on") 
            addObject(abilities,conf.SiegeTank.seige_mode_off,197,  "changestate" ,  "seige_mode off") 
        ...
        class Viking():
            ...
            addObject(abilities,conf.Viking.assault_mode_on,213,  "changestate" ,  "assault_mode on") 
            addObject(abilities,conf.Viking.assault_mode_off,214,  "changestate" ,  "assault_mode off") 
        ...
        class Medivac():
            ...
            addObject(abilities,conf.Medivac.unload_all,222,  "action" ,  "unload") 
            addObject(abilities,conf.Medivac.unload_all_moving,223,  "action" ,  "unload") 
            addObject(abilities,conf.Medivac.unload_unit,224,  "action" ,  "unload") 
            addObject(abilities,conf.Medivac.load_unit,225,  "action" ,  "load") 
        ...
        class Raven():
            ...
            addObject(abilities,conf.Raven.auto_turret,234,  "action" ,  "auto_turret") 
            addObject(abilities,conf.Raven.point_defence_drone,235,  "action" ,  "point_defence_drone") 
        ...
        class Banshee():
            ...
            addObject(abilities,conf.Banshee.cloak_on,244,  "action" ,  "cloak_on") 
            addObject(abilities,conf.Banshee.cloak_off,245,  "action" ,  "cloak_off") 
        ...
        AddAll([SCV,MULE,Marine,Marauder,Ghost,SiegeTank,Thor,Viking,Medivac,Raven,Banshee,Battlecruiser],types,abilities)
        ...
        def TerranMain(clazz):
            ...
            addObject(clazz.abilities,conf.TerranMain.train_scv,264,  "train" ,  "train_scv")
            return clazz
        ...
        class Bunker():
            ...
            addObject(abilities,conf.Bunker.unload_all,282,  "action" ,  "unload") 
            addObject(abilities,conf.Bunker.unload_unit,283,  "action" ,  "unload") 
        ...
        class CommandCenter(SC2Object):
            ...
            addObject(abilities,conf.CommandCenter.lift_down,295,  "action" ,  "lift")
            addObject(abilities,conf.CommandCenter.unload_all,296,  "action" ,  "unload")
            ...
            addObject(abilities,conf.CommandCenter.upgradeto_orbital_command,299,  "morph" ,  "upgradeto")
            addObject(abilities,conf.CommandCenter.upgradeto_orbital_command_cancel,300,  "cancel" ,  "upgradetoc")
            addObject(abilities,conf.CommandCenter.upgradeto_planetary_fortress,301,  "morph" ,  "upgradeto")
            addObject(abilities,conf.CommandCenter.upgradeto_planetary_fortress_cancel,302,  "cancel" ,  "upgradetoc")
            class Flying():
                code = 0x004001
        ...
        class OrbitalCommand(SC2Object):
            ...
            addObject(abilities,conf.OrbitalCommand.lift_down,314,  "action" ,  "lift")
            addObject(abilities,conf.OrbitalCommand.mule_target,315,  "train" ,  "mule")
            addObject(abilities,conf.OrbitalCommand.mule_location,316,  "train" ,  "mule")
            addObject(abilities,conf.OrbitalCommand.extra_supply,317,  "build" ,  "extra_supply")
            addObject(abilities,conf.OrbitalCommand.scanner_sweep,318,  "spell" ,  "scanner")
            class Flying():
                code = 0x00a201
        ...
        class EngineeringBay(SC2Object):
            ...
            addObject(abilities,conf.EngineeringBay.inftantry_weapons_1,330,  "upgrade" ,  "inftantry_weapons_1")
            addObject(abilities,conf.EngineeringBay.inftantry_weapons_2,331,  "upgrade" ,  "inftantry_weapons_2")
            addObject(abilities,conf.EngineeringBay.inftantry_weapons_3,332,  "upgrade" ,  "inftantry_weapons_3")
            addObject(abilities,conf.EngineeringBay.neosteel_frame,333,  "upgrade" ,  "neosteel_frame")
            addObject(abilities,conf.EngineeringBay.inftantry_armor_1,334,  "upgrade" ,  "inftantry_armor_1")
            addObject(abilities,conf.EngineeringBay.inftantry_armor_2,335,  "upgrade" ,  "inftantry_armor_2")
            addObject(abilities,conf.EngineeringBay.inftantry_armor_3,336,  "upgrade" ,  "inftantry_armor_3")
        ...
        class GhostAcademy(SC2Object):
            ...
            addObject(abilities,conf.GhostAcademy.arm_silo_w_nuke,344,  "train" ,  "arm_silo_w_nuke")
        ...
        class Armory(SC2Object):
            ...
            addObject(abilities,conf.Armory.ship_plating_2,370,  "upgrade" ,  "lship_plating_2")
        ...
        class Barracks(SC2Object):
            ...
            addObject(abilities,conf.Barracks.lift_down,388,  "action" ,  "lift")
    
            addObject(abilities,conf.Barracks.addon_techlab,390,  "build" ,  "techlab")
            addObject(abilities,conf.Barracks.addon_techlab_move,390,  "build" ,  "techlab")
            addObject(abilities,conf.Barracks.addon_techlab_cancel,392,  "cancel" ,  "techlab_cancel")

            addObject(abilities,conf.Barracks.addon_reactor,394,  "build" ,  "reactor")
            addObject(abilities,conf.Barracks.addon_reactor_move,394,  "build" ,  "reactor")
            addObject(abilities,conf.Barracks.addon_reactor_cancel,396,  "cancel" ,  "reactor_cancel")
        ...
        class Factory(SC2Object):
            ...
            addObject(abilities,conf.Factory.lift_down,430,  "action" ,  "lift")

            addObject(abilities,conf.Factory.addon_techlab,432,  "build" ,  "techlab")
            addObject(abilities,conf.Factory.addon_techlab_move,432,  "build" ,  "techlab")
            addObject(abilities,conf.Factory.addon_techlab_cancel,434,  "cancel" ,  "techlab_cancel")

            addObject(abilities,conf.Factory.addon_reactor,436,  "build" ,  "reactor")
            addObject(abilities,conf.Factory.addon_reactor_move,436,  "build" ,  "reactor")
            addObject(abilities,conf.Factory.addon_reactor_cancel,438,  "cancel" ,  "reactor_cancel")
        ...
        class Starport(SC2Object):
            ...
            addObject(abilities,conf.Starport.lift_down,474,  "action" ,  "lift")

            addObject(abilities,conf.Starport.addon_techlab,476,  "build" ,  "techlab")
            addObject(abilities,conf.Starport.addon_techlab_move,476,  "build" ,  "techlab")
            addObject(abilities,conf.Starport.addon_techlab_cancel,478,  "cancel" ,  "techlab_cancel")

            addObject(abilities,conf.Starport.addon_reactor,480,  "build" ,  "reactor")
            addObject(abilities,conf.Starport.addon_reactor_move,480,  "build" ,  "reactor")
            addObject(abilities,conf.Starport.addon_reactor_cancel,482,  "cancel" ,  "reactor_cancel")
        ...
        AddAll([SupplyDepot,Bunker,CommandCenter,OrbitalCommand,Barracks,Barracks.Techlab,
            Factory,Factory.Techlab,Starport,Starport.Techlab,
            EngineeringBay,Armory,FusionCore,GhostAcademy],types,abilities)
        ...
        class Probe(SC2Object):
            ...
            addObject(abilities,conf.Probe.fleet_beacon,525,  "build" ,  "fleet")
            addObject(abilities,conf.Probe.twilight_council,526,  "build" ,  "twilight")
            addObject(abilities,conf.Probe.photon_cannon,527,  "build" ,  "photon")
            ...
            addObject(abilities,conf.Probe.templar_archives,530,  "build" ,  "templar")
            addObject(abilities,conf.Probe.dark_shrine,531,  "build" ,  "dark")
            ...
            addObject(abilities,conf.Probe.cybernetics_core,534,  "build" ,  "cybernetics")
        ...
        class Sentry():
            ...
            addObject(abilities,conf.Sentry.hallucinate_high_templar,553,  "action" ,  "hallucinate_templar")
            ...
            addObject(abilities,conf.Sentry.hallucinate_void_ray,558,  "action" ,  "hallucinate_void_ray")
            ...
            addObject(abilities,conf.Sentry.guardian_shield,561,  "action" ,  "gs")
            addObject(abilities,conf.Sentry.force_field,562,  "action" ,  "ff")
        ...
        class WarpPrism():
            ...
            addObject(abilities,conf.WarpPrism.unload_all,587,  "action" ,  "unload")
            addObject(abilities,conf.WarpPrism.unload_all_moving,588,  "action" ,  "unload")
            ...
            addObject(abilities,conf.WarpPrism.phase_mode,591,  "changestate" ,  "phase")
            addObject(abilities,conf.WarpPrism.transport_mode,592,  "changestate" ,  "transport")
        ...
        class Pheonix():
            ...
            addObject(abilities,conf.Pheonix.gravitation_beam_on,600,  "action" ,  "gravitation")
        ...
        class Mothership():
            ...
            addObject(abilities,conf.Mothership.mass_recall,617,  "action" ,  "recall")
        
        AddAll([Probe,Stalker,Sentry,HighTemplar,DarkTemplar,WarpPrism,Pheonix,Carrier, Mothership ],types,abilities)
        ...
        class Gateway(SC2Object):
            ...
            addObject(abilities,conf.Gateway.high_templar,640,  "train" ,  "high")
            addObject(abilities,conf.Gateway.dark_templar,641,  "train" ,  "dark")
            addObject(abilities,conf.Gateway.sentry,642,  "train" ,  "sentry")
            addObject(abilities,conf.Gateway.to_warpgate,643,  "changestate" ,  "towarpgate")
            ...
            class WarpGate(SC2Object):
                ...
                abilities = {}
                addObject(abilities,conf.Gateway.WarpGate.warp_zealot,638,  "train" ,  "warp zealot")
                addObject(abilities,conf.Gateway.WarpGate.warp_stalker,639,  "train" ,  "warp stalker")
                addObject(abilities,conf.Gateway.WarpGate.warp_high_templar,640,  "train" ,  "warp high")
                addObject(abilities,conf.Gateway.WarpGate.warp_dark_templar,641,  "train" ,  "warp dark")
                addObject(abilities,conf.Gateway.WarpGate.warp_sentry,642,  "train" ,  "warp sentry")
                addObject(abilities,conf.Gateway.WarpGate.to_gateway,655,  "changestate" ,  "togateway")
        ...
        class Forge(SC2Object):
            ...
            addObject(abilities,conf.Forge.ground_armour_1,665,  "upgrade" ,  "ground_armour_1")
            addObject(abilities,conf.Forge.ground_armour_2,666,  "upgrade" ,  "ground_armour_2")
            addObject(abilities,conf.Forge.ground_armour_3,667,  "upgrade" ,  "ground_armour_3")
        ...
        class CyberneticsCore(SC2Object):
            ...
            addObject(abilities,conf.CyberneticsCore.air_armour_1,680,  "upgrade" ,  "air_armour_1")
            addObject(abilities,conf.CyberneticsCore.air_armour_2,681,  "upgrade" ,  "air_armour_2")
            addObject(abilities,conf.CyberneticsCore.air_armour_3,682,  "upgrade" ,  "air_armour_3")
        ...
        class Stargate(SC2Object):
            ...
            abilities = {}
            addObject(abilities,conf.Stargate.pheonix,702,  "train" ,  "pheonix")
        ...
        class FleetBeacon(SC2Object):
            ...
            abilities = {}
            addObject(abilities,conf.FleetBeacon.gavitation_catapault,718,  "upgrade" ,  "gavitation")

        @Research
        @DataObject
        class TemplarArchive(SC2Object):
            code = conf.TemplarArchive.code
            abilities = {}
            addObject(abilities,conf.TemplarArchive.psi_storm,725,  "upgrade" ,  "psi")
        ...
        AddAll([Nexus,Gateway,Gateway.WarpGate, Forge,  CyberneticsCore, RoboticsFacility,Stargate,TwilightCouncil,
        FleetBeacon,  TemplarArchive,  RoboticsBay ],types,abilities)
        ...
        class Larva(SC2Object):
            ...
            addObject(abilities,conf.Larva.corrupter,754,  "train" ,  "corrupter")
        ...
        class Drone(SC2Object):
            ...
            addObject(abilities,conf.Drone.return_cargo,763,  "action" ,  "return")
            ...
            addObject(abilities,conf.Drone.spawning_pool,768,  "build" ,  "spawning")
            addObject(abilities,conf.Drone.evolution_chamber,769,  "build" ,  "evolution")
            addObject(abilities,conf.Drone.hydra_den,770,  "build" ,  "hydra den")
            ...
            addObject(abilities,conf.Drone.infestation_pit,774,  "build" ,  "infestation")
            addObject(abilities,conf.Drone.nydus_network,775,  "build" ,  "nydus")
            addObject(abilities,conf.Drone.baneling_nest,776,  "build" ,  "baneling")
        ...
        class Zergling(SC2Object):
            ...
            class BanelingCocoon():
                ...
                abilities = {}
                addObject(abilities,conf.Zergling.BanelingCocoon.cancel_baneling,791,  "cancel" ,  "cancel baneling")
        ...
        class Corruptor(SC2Object):
            ...
            class BroodlordCocoon(SC2Object):
                ...
                abilities = {}
                addObject(abilities,conf.Corruptor.BroodlordCocoon.cancel_broodlord,806,  "cencel" ,  "cancel broodlord")
        ...
        class Overseer():
            ...
            abilities = {}
            addObject(abilities,conf.Overseer.changling,899,  "action" ,  "changling")
            addObject(abilities,conf.Overseer.contaminate,900,  "action" ,  "contaminate")
            
        AddAll([Larva,Drone,Zergling,Zergling.BanelingCocoon,Corruptor,
        Corruptor.BroodlordCocoon,Overlord,Overlord.OverseerCocoon,
        Egg,Queen,Baneling, Roach,Hydralisk,Infestor,Ultralisk,Overseer],types,abilities)    
        
        ###ZERG Buildings
        def ZergMain(clazz):
            addObject(clazz.abilities,conf.ZergMain.worker_rally_point,908,  "rally" ,  "worker rally")
            addObject(clazz.abilities,conf.ZergMain.worker_rally_target,909,  "rally" ,  "worker rally")
            addObject(clazz.abilities,conf.ZergMain.unit_rally_point,910,  "rally" ,  "unit rally")
            addObject(clazz.abilities,conf.ZergMain.unit_rally_target,911,  "rally" ,  "unit rally")
        
            addObject(clazz.abilities,conf.ZergMain.queen,913,  "train" ,  "queen")
            addObject(clazz.abilities,conf.ZergMain.evolve_burrow,914,  "upgrade" ,  "evolve_burrow")
            addObject(clazz.abilities,conf.ZergMain.evolve_carapace,915,  "upgrade" ,  "evolve_carapace")
            addObject(clazz.abilities,conf.ZergMain.evolve_ventral_sacs,916,  "upgrade" ,  "evolve_ventral_sacs")
            return clazz
        ...
        class NydusNetwork():
            ...
            addObject(abilities,conf.NydusNetwork.nydus,1037,  "build" ,  "nydus")
